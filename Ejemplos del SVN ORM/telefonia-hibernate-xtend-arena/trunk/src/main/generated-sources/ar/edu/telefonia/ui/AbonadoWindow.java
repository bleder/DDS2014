...
public class AbonadoWindow extends SimpleWindow<BuscarAbonadoAppModel> {
  ...
  protected Table<Abonado> createResultsGrid(final Panel mainPanel) {
    ...
    final Procedure1<Table<Abonado>> _function = new Procedure1<Table<Abonado>>() {
      public void apply(final Table<Abonado> it) {
        ...
        AbonadoWindow.this.describeResultsGrid(it);
      }
    };
    return ObjectExtensions.<Table<Abonado>>operator_doubleArrow(_table, _function);
  }
